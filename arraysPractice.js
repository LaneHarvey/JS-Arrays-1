...
//Have divider return an Array with the
// first item in the array being the evens array (all the even values from nums)
...
/*
  ...
  In both the removeItem function and the addItem function,
  // you will also need to check for valid aurguments. Specrunner will try to call your functions without passing
  in valid aurguments. When this happens, you will need to respond by returning an empty array.
*/
